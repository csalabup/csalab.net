...
{!! Form::model($color, array('method' => 'put', 'route' => array('update-color', $color->id), 'files' => true)) !!}      

<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Name: {{ $color->color }}</h3>
        ...
        <div class="tab-pane active" id="basic">
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
           ...
           <div class="form-group">
            ...
            {!! Form::text('color', null , array('class' => 'form-control', 'autofocus'=>'', 'placeholder'=>'Color', 'value' => 'old(color)')) !!}
           </div>
