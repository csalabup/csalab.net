...
<?php echo Form::model($category, array('method' => 'put', 'route' => array('update-category', $category->id), 'files' => true)); ?>
   ...
   <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
    ...
    <div id="my-tab-content" class="tab-content">
        ...
        <div class="tab-pane" id="advance">
           ...
           <div class="form-group">
            <?php echo Form::checkbox('include_in_top_menu', true, null, ['id' => 'include_in_top_menu', 'value' => 'old("include_in_top_menu")']); ?>
