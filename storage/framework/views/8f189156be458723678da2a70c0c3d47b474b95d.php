...
<?php echo Form::model($role, array('method' => 'put', 'route' => array('update-role', $role->id))); ?>      

<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Name: <?php echo e($role->role); ?></h3>
   ...
   <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
    ...
    <div id="my-tab-content" class="tab-content">
        ...
        <div class="tab-pane" id="items">
            ...
            <input type="checkbox" name="<?php echo e($user->id); ?>" checked/>
