...
<div class="box">
  ...
  <li type="button" class="list-group-item"><a href="<?php echo e(URL::route('edit-size', $size->id)); ?>"><?php echo e($size->size); ?></a>
  
  
  <div class="btn-group pull-right" role="group" aria-label="...">
  <a class="btn btn-default btn-xs" href="<?php echo e(URL::route('edit-size', $size->id)); ?>">edit</a>
