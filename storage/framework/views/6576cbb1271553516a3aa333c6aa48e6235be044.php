...
<div class="box">
  ...
  <li type="button" class="list-group-item"><a href="<?php echo e(URL::route('edit-role', $role->id)); ?>"><?php echo e($role->role); ?></a>
  
  
  <div class="btn-group pull-right" role="group" aria-label="...">
  <a class="btn btn-default btn-xs" href="<?php echo e(URL::route('edit-role', $role->id)); ?>">edit</a>
